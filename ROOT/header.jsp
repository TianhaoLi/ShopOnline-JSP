		...
		<div class="container">
			<nav class="navbar navbar-default" role="navigation">
				<div class="navbar-header">
					...
					<h1 class="navbar-brand"><a href="${pageContext.request.contextPath }/">联想商城</a></h1>
				</div>
				<!--navbar-header-->
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						...
						<c:choose><c:when test="${empty user }">
							<li><a href="${pageContext.request.contextPath }/user_register.jsp" <c:if test="${param.flag==9}">class="active"</c:if>>注册</a></li>
							<li><a href="${pageContext.request.contextPath }/user_login.jsp" <c:if test="${param.flag==10}">class="active"</c:if>>登录</a></li>
							</c:when><c:otherwise>
			...
			<div class="header-info">
				<div class="header-right search-box">
					<a href="javascript:;" <c:if test="${param.flag==6}">style="background-color:#F07818"</c:if>><span class="glyphicon glyphicon-search" aria-hidden="true"></span></a>				
					<div class="search">
				...
				<!-- 购物车 -->
					<a href="${pageContext.request.contextPath }/goods_cart.jsp" <c:if test="${param.flag==7}">style="background-color:#F07818"</c:if>>
