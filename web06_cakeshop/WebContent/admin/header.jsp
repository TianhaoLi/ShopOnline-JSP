	...
	<nav class="navbar navbar-default" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				<a class="navbar-brand" href="${pageContext.request.contextPath }/admin/admin_index.jsp">联想商城后台</a>
			</div>
			<div>
				<ul class="nav navbar-nav">
					...
					<li ><a href="${pageContext.request.contextPath }/user_center.jsp">修改密码</a></li>
